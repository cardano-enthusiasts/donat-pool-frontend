...
const Page = () => {
  ...
  return (
    <Common>
      ...
      {fundraisingsAreBeingFetched && <div>donat pools are being fetched</div>}
      {fundraisings && (
        <CardsWrapper>
          {fundraisings
      ...
      {fetchFundraisingsError && <div className="text-error">An error happened while fetching donat pools</div>}
    </Common>
  );
};
