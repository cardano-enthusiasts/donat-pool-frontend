...
import { Wrapper, Alert, ColorTitle, Li, Line, SubSection, Subtitle, Title, Ul, SectionWrapper } from './FAQ.styled';
      ...
      <Wrapper>
        <DropdownSection title="What is Donat.Pool?">
          <SectionWrapper>
            ...
            ADA.
            <Alert>Current Donat.Pool version is available on the Cardano PreProduction testnet only.</Alert>
          </SectionWrapper>
        </DropdownSection>
        ...
        <DropdownSection title="How to start a new project?">
          <SectionWrapper>
            <Ul>
              <Li>
                To start a project, go to the &#39;My projects&#39; page and press the &#39;Create a new project&#39;
                button. A fundraising project consists of a title, description, target amount and duration. Choose these
                parameters and press the confirm button.
              </Li>
              <Li>
                Donat.Pool will call the Nami wallet extension and it will open with transaction info. Here you can
                check the transaction amount and transaction fee and sign the transaction using your Nami wallet
                password.
              </Li>
            </Ul>
            <Alert>
              Technically creating a project means that you create a separate storage on the Donat.Pool script address
              for your project funds, so you have to put 4 ADA to this storage temporarily. You will get these 4 ADA
              back along with the funds raised. These 4 ADA are taken from your wallet so be ready to sign the
              transaction with Nami.
            </Alert>
            <Ul>
              <Li>
                Wait for transaction confirmation. Creating a new project is a blockchain transaction so you have to
                wait for a while until the transaction is confirmed.
              </Li>
              <Li>
                After confirmation you get a unique link to the newly created project which you may share with the
                community.
              </Li>
            </Ul>
          </SectionWrapper>
