import kateSrc from '@public/img/kate.png';
import mariyaSrc from '@public/img/mariya.png';
import oksanaSrc from '@public/img/oksana.png';
import olgaSrc from '@public/img/olga.png';
import svetlanaSrc from '@public/img/svetlana.png';
