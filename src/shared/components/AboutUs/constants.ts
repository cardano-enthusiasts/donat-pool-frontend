...
const STYLES = {
  kate: 'absolute left-[-3.125rem] top-[5.125rem] z-[2] h-auto w-[21.875rem] shrink-0 max-1.5xl:left-0 max-xl:top-[5.6875rem] max-xl:w-[16.4375rem] max-md:top-[6.0625rem] max-md:w-[10.9375rem]',
  oksana:
