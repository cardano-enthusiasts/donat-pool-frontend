...
const Modal = ({
  ...
  return (
    <Dialog className="fixed inset-0 flex items-center justify-center bg-blue/40 p-5" open={isOpen} onClose={onClose}>
      <Dialog.Panel
        className={`${PANEL_THEME_TO_CLASSNAME[panelTheme]} max-h-full w-11/12 overflow-y-auto rounded-md p-5 shadow-[0_15px_40px_theme(colors.blue.DEFAULT)] md:w-[37.5rem] md:px-10 md:pb-15 md:pt-10`}
      >
        {title && (
